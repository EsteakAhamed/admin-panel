...
const Register = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setError(err.response?.data?.message || 'Failed to register. Please check your connection.');
        } finally {
            setLoading(false);
        }
    };
            ...
            >
                <Card className="border-zinc-800 bg-zinc-900/80 backdrop-blur-xl shadow-xl">
                    <CardHeader className="space-y-1 text-center">
                        <CardTitle className="text-2xl font-bold bg-gradient-to-r from-pink-400 to-indigo-400 bg-clip-text text-transparent">
                            Create an Account
                        </CardTitle>
                        <CardDescription>
